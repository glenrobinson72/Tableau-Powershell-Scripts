...
#
#   Thanks to Gavin Butler on work done wth Chunking Payloads
#
###############################################
...
function TS-UpdateSite
{
 param(
  ...
  [string[]] $TierCreatorCapacity="",
  [string[]] $TierExplorerCapacity="",
  [string[]] $TierViewerCapacity="",
  [string[]] $UserQuota = "",
 ...
 try
 {
  ...
  if ($TierCreatorCapacity -ne '') {$body += ' tierCreatorCapacity ="'+ $TierCreatorCapacity +'"'}
  if ($TierExplorerCapacity -ne '') {$body += ' tierExplorerCapacity ="'+ $TierExplorerCapacity +'"'}
  if ($TierViewerCapacity -ne '') {$body += ' tierViewerCapacity ="'+ $TierViewerCapacity +'"'}
 ...
 try
  {
   ...
   if ($Chunked -eq 'true') 
    {TS-PublishWorkbook_CHUNKED -ProjectID $project_ID -WorkbookName $WorkbookName -ConnectionCredentials $connectionCredentials -WorkbookFile $WorkbookFile -WorkbookPath $WorkbookPath -OverWrite $OverWrite -ShowTabs $ShowTabs }
   else
    {
